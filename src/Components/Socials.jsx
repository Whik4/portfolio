    ...
    return (
        <div className="socials">
            <ul className="socials-list">
                ...
                <li className="socials-list-item">
                    <a className="social-icon" href="https://www.hackerrank.com/amanm3620" target="_blank"><i class="fab fa-hackerrank"></i></a>
                </li>
                <li className="socials-list-item">
                    <a className="social-icon" href="https://github.com/Whik4" target="_blank"><i class="fab fa-github"></i></a>
                </li>
            </ul>
        </div>
    )
